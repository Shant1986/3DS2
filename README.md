...
<div style="width: 640px; height: 480px; margin: 10px; position: relative;"><iframe allowfullscreen frameborder="0" style="width:640px; height:480px" src="https://www.lucidchart.com/documents/embeddedchart/01fc702d-edf2-4028-8ec9-5579ecdd074f" id="9EcxWS-ld~cA"></iframe></div>
...
**Table 2.1.1**: Non-exhaustive list of possible inherence elements

| Elements or Measures      | SCA Compliant?    |
| -------------             |:-------------:    |
|1. Fingerprint Scanning      | Yes               |
|2. Voice Recognition         | Yes               |
|3. Hand and Face Geometry     | Yes               |
|4. Retina and Iris Scanning   | Yes               |
|5. Keystroke Dynamics         | Yes               |
|6. Heart rate or other body movement pattern verifying that the PSU is the PSU (e.g. for wearable devices)   | Yes               |
|7. The angle at which the device is held  | Yes               |
|8. Information transmitted using a communication protocol, such as EMV® 3-D Secure                | No (for approaches currently observed in the market)          |
|9. Memorized swiping path | No               |

**Table 2.1.2**: Non-exhaustive list of possible possession elements

| Elements       | SCA Compliant?    |
| -------------             |:-------------:    |
|1. Possession of a device evidenced by an OTP generated by, or received on, a device (hardware or software token generator, SMS OTP)     | Yes               |
|2. Possession of a device evidenced by a signature generated by a device (hardware or software token)    | Yes               |
|3. Card or device evidenced through a QR code (or photo TAN) scanned from an external device     | Yes               |
|4. App or browser with possession evidenced by device binding — such as through a security chip embedded into a device or private key linking an app to a device, or the registration of the web browser linking a browser to a device    | Yes               |
|5. Card evidenced by a card reader    | Yes               |
|6. Card with possession evidenced by a dynamic card security code    | Yes               |
|7. App installed on the device    | No               |
|8. Card with possession evidenced by card details (printed on the card)     | No (for approaches currently observed in the market)               |
|9. Card with possession evidenced by a printed element (such as an OTP list)    | No (for approaches currently observed in the market)           |

**Table 2.1.3**: Non-exhaustive list of possible knowledge elements

| Element      | SCA Compliant?    |
| -------------             |:-------------:    |
|1. Password    | Yes               |
|2. PIN    | Yes               |
|3. Knowledge-based challenge questions    | Yes               |
|4. Passphrase    | Yes               |
|5. Memorised swiping path     | Yes               |
|6. Email address or user name    | No               |
|7. Card details (printed on the card)    | No               |
|8. OTP generated by, or received on, a device (hardware or software token generator, SMS OTP)     | No (for approaches currently observed in the market)               |
|9. Printed matrix card or OTP list     | No               |
...
<div style="width: 640px; height: 480px; margin: 10px; position: relative;"><iframe allowfullscreen frameborder="0" style="width:640px; height:480px" src="https://www.lucidchart.com/documents/embeddedchart/002adeab-8afb-488f-b5da-ec931d05c1b0" id="LCcxcZK3Va-a"></iframe></div>
